...
public class UserController {
    ...
    public String updateUser(@RequestParam("name") String name,@RequestParam("id") long id,@RequestParam("email") String email,Model model) throws HandlerException {
    ...
    public String updateUserById(@RequestParam("name") String name,@RequestParam("id") long id,@RequestParam("email") String email,Model model) throws HandlerException {
    ...
    @GetMapping("/create")
    public String name(@RequestParam("name") String name, @RequestParam("email") String email) throws HandlerException {
        LOGGER.debug("Create user with name ({}) and email ({})", name, email);
        User user = new User();
        user.setName(name);
        user.setEmail(email);
